...
const Section2 = () => {
  ...
  return (
    <div>
      <div className="flex md:flex-col justify-around md:items-center gap-4 py-8  font-semibold mb-10">
        {/* Step1 */}
                  ...
                  <ul className="pl-4 mt-1 space-y-1 text-gray-500">
                    {filter.options.length > 0 ? (
                      filter.options.map((option, idx) => (
                        <li key={idx}>
                          <label className="flex items-center justify-between md:justify-around">
                            {option}
                            <input type="checkbox" />
                          </label>
                        </li>
